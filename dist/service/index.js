...
function _getPresences() {
  ...
  /*#__PURE__*/
  _regenerator.default.mark(function _callee(since) {
    var data;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            return _context.abrupt("return", data.filter(function (item) {
              return new Date(item.entryTime) > since;
            }));
...
function writeFilePresences(_x4) {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return writeFileAsync('./src/service/presences.json', JSON.stringify(data));
    ...
    return _regenerator.default.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return readFileAsync('./src/service/presences.json');
